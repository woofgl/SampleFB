    ...
    (function ($) {
        ...
        brite.registerView("DataTable", {loadTmpl:true, emptyParent:true}, {
            ...
            events:{
                ...
                "click; .next":function (e) {
                    ...
                    if (view.opts.withPaging) {
                        var opts = view.opts.dataOpts;
                        if (opts.pageIndex + 1 < view.numOfPages) {
                            opts.pageIndex++;
                            refreshDataTable.call(view);
                        }
                    }
                ...
                "click; [data-action='toggle-children']":function (e) {
                    var view = this;
                    var $e = view.$element;
                    if (view.isTreeMode) {
                ...
                "click; [data-action='sort']": function(event){
                    var view = this;
        ...
        function renderTableRow(dataType, columnDef, obj, hasChildren, nestLevel) {
            ...
            for (var j in columnDef) {
                ...
                if (colDef.propName && obj[colDef.propName]) {
                    html += obj[colDef.propName];
        ...
        function renderPagingFooter() {
            var view = this;
            var opts = view.opts.dataOpts || {};
            return $("#tmpl-DataTable-Foot").render({pageIndex:opts.pageIndex,numOfPages:view.numOfPages,pageSize: opts.pageSize });
        }
